...
namespace AppCRUD_MVC
{
    public partial class frmCrud : Form
    {
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Por favor, preencha todo o fórmulario.", "Campos Obrigatórios", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.ActiveControl = txtNome;
                return;
            }
            Pessoa pessoa = new Pessoa();
            pessoa.Inserir(txtNome.Text, txtIdade.Text);
            MessageBox.Show("Pessoa cadastrada com sucesso!", "Inserção", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            var result = MessageBox.Show("Deseja realmente fechar o programa?", "Fechar", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
